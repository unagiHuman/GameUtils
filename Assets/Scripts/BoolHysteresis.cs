...
public class BoolHysteresis : MonoBehaviour {
	...
	void Start()
	{
		onTrueReactiveProperty = 
			this.ObserveEveryValueChanged (p => p._onTrue)
				.Throttle (System.TimeSpan.FromMilliseconds(1000))
				.ToReactiveProperty ()
				.AddTo(gameObject);
	}
	...
	/// </summary>
	public void StartHisteresisLoop(System.Func<bool> boolReturnFunc)
	{
	...
	private IEnumerator CalcHisteresisLoopCotourine(System.Func<bool> boolReturnFunc)
	{
